...
//		synchroList = Collections.synchronizedList(sendNeighbours);
		...
		active.set(true);
		//Wenn der Knoten keine Nachbarn hat dann stoppe diesen Thread
...
//					System.out.println(name + ": " + replies.get() + " Nachrichten erhalten " + expMsg.get() + " benötigt");
		...
		if (!initiator) {
			...
			System.out.println("Knoten abgearbeitet: "+uniqueNodes.size()+"\n Es können Knoten bei Random fehlen wenn diese keine Verbindung zum Initiator haben");
		} else {
